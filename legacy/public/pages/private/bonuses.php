...
mt_cabinet_auth_log($User, $Router, 'bonuses');
...
if ((int)$User->id <= 0) {
    \Illuminate\Support\Facades\Log::channel('cabinet')->warning('[CABINET AUTH] Missing client_id on bonuses page', [
            ...
            <div class="tabs_links_container hidden-xs">
                <div class="private_links">
                    <div class="private_link_wrapper">
                        <a href="<?php echo $privateMenuLinks[80]['url']?>" class="private_tab h4_title">
                            <?php echo $privateMenuLinks[80]['title']?>
                        </a>
                    </div>
                    <div class="private_link_wrapper">
                        <a href="<?php echo $privateMenuLinks[78]['url']?>" class="private_tab h4_title">
                            <?php echo $privateMenuLinks[78]['title']?>
                        </a>
                    </div>
                    <div class="private_link_wrapper">
                        <a href="<?php echo $privateMenuLinks[79]['url']?>" class="private_tab h4_title">
                            <?php echo $privateMenuLinks[79]['title']?>
                        </a>
                    </div>
                    <div class="private_link_wrapper">
                        <a href="<?php echo $privateMenuLinks[82]['url']?>" class="private_tab h4_title">
                            <?php echo $privateMenuLinks[82]['title']?>
                        </a>
                    </div>
                    <div class="private_link_wrapper">
                        <a href="<?php echo $privateMenuLinks[81]['url']?>" class="private_tab h4_title active">
                            <?php echo $privateMenuLinks[81]['title']?>
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table">
                                    ...
                                    <?php foreach ($bonusTransactions as $transaction) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $sign . $amountUah; ?> грн</td>
                                            <td><?php echo htmlspecialchars((string)$orderId, ENT_QUOTES, 'UTF-8'); ?></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
