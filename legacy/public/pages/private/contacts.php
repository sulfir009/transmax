...
mt_cabinet_auth_log($User, $Router, 'contacts');
...
if ((int)$User->id <= 0) {
    \Illuminate\Support\Facades\Log::channel('cabinet')->warning('[CABINET AUTH] Missing client_id on contacts page', [
        ...
        <div class="private_links_wrapper">
            <div class="tabs_links_container hidden-xs">
                <div class="private_links">
                    ...
                    <div class="private_link_wrapper">
                        <a href="<?=$privateMenuLinks[79]['url']?>" class="private_tab h4_title active">
            ...
            <div class="container">
                ...
                <div class="flex-row gap-x-32 gap-y-60">
                    <div class="col-xxl-6">
                        <div class="shadow_block private_contacts_block">
                            <div class="private_contacts_header">
                                <?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_NA_ELEKTRONNU_POSHTU_NADSILAMO_MARSHRUTNI_KVITANCI']?>
                            </div>
                            <div class="flex-row gap-26">
                                <div class="col-sm-12">
                                    <div class="row">
                                        <input type="text" class="c_input" placeholder="<?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_YOREMAILGMAILCOM']?>" value="<?=$User->email?>" readonly>
                                    </div>
                                </div>
                                <?/*
                                <div class="col-sm-5">
                                    <button class="contact_act_btn blue_btn h4_title">
                                        <?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_ZMINITI_EMAIL']?>
                                    </button>
                                </div>*/?>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-6">
                        <div class="shadow_block private_contacts_block">
                            <div class="private_contacts_header">
                                <?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_TELEFONOM_MI_ZMOZHEMO_']?>
                            </div>
                            <div class="flex-row gap-26">
                                <div class="col-sm-7">
                                    <div class="row">
                                        <div class="phone_input_wrapper flex_ac">
                                            <select class="phone_country_code flex_ac" onchange="changeInputMask(this)" id="phone_code">
                                                ...
                                                foreach ($getPhoneCodes AS $k=>$phoneCode){
                                                    ...
                                                    <option value="<?=$phoneCode['id']?>" data-mask="<?=$phoneCode['phone_mask']?>" data-placeholder="<?=$phoneCode['phone_example']?>" <?if ($k == 0 || $clientInfo['phone_code'] == $phoneCode['id']){echo 'selected';}?>><?=$phoneCode['phone_country']?></option>
                                                <?}?>
                                            </select>
                    ...
                    <div class="col-xxl-12">
                        <div class="shadow_block private_data_block">
                            <div class="private_data_block_header h3_title">
                                <?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_OSOBISTI_DANI']?>
                            </div>
                            <div class="private_data_inputs">
                                <div class="flex-row gap-x-50 gap-y-30">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <input type="text" class="c_input" placeholder="<?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_IMYA']?>"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <input type="text" class="c_input" placeholder="<?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_FAMILIYA']?>"
                            ...
                            <button class="save_changes_btn h4_title blue_btn" onclick="updateClientInfo()">
                                <?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_ZBEREGTI_ZMINI']?>
                            </button>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function updatePhone(event){
        ...
        if (phone === '') {
            notifySafe('<?=$GLOBALS['dictionary']['MSG_MSG_REGISTER_VVEDITE_NOMER_TELEFONA']?>');
            return;
        }
           ...
           type:'post',
            ...
            success:function(response){
                ...
                if (result === 'err'){
                    ...
                    notifySafe('<?=$GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_DANNYE_USPESHNO_IZMENENY']?>');
                }
            },
            error:function(){
                stopLoaderSafe();
