...
mt_cabinet_auth_log($User, $Router, 'future');
...
if ((int)$User->id <= 0) {
    \Illuminate\Support\Facades\Log::channel('cabinet')->warning('[CABINET AUTH] Missing client_id on future page', [
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="page_content_wrapper">
            ...
            <div class="d_none"><?=out($getFutureRides)?></div>
                    ...
                    <div class="private_tickets_wrapper">
                        <div class="flex-row gap-30">
                            <?foreach ($futureRidesArray as $k => $futureRide) {
                                ...
                                ?>
                                <div class="col-xxl-6">
                                    <div class="ticket_card flex-row private_ticket shadow_block" data-id="<?=$futureRide['id']?>">
                                        <div class="col-md-12">
                                            <div class="ticket_info">
                                                <div class="ticket_info_header flex_ac">
                                                    ...
                                                    <?= date('d', strtotime($futureRide['tour_date'])) . ' ' . $month['title'] . ' ' . date('Y', strtotime($futureRide['tour_date'])) ?>
                                                </span>
                                                    </div>
                                                    <div class="ride_description_wrapper flex_ac">
                                                        <div class="ride_description par">
                                                            ...
                                                            <span><?= $futureRide['departure_city'] . ' - ' . $futureRide['arrival_city'] ?></span>
                                                        </div>
                                                        <div class="ride_description par">
                                                            <span><?= $GLOBALS['dictionary']['MSG_MSG_TICKETS_AVTOBUS'] ?></span>
                                                            <span><?= $futureRide['bus_title'] ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="ticket_ride_info_block flex-row gap-30">
                                                    <div class="col-lg-4 col-sm-6 col-xs-12">
                                                        <div class="ticket_ride_departure ticket_ride_info">
                                                            <div class="ticket_ride_time flex_ac">
                                                                ...
                                                                <span class="btn_txt"><?= date('H:i', strtotime($futureRide['departure_time'])) ?></span>
                                                            </div>
                                                            <div class="ticket_ride_city btn_txt">
                                                                <?= $futureRide['departure_city'] ?>
                                                            </div>
                                                            <div class="ticket_ride_checkpoint manrope">
                                                                <?= $futureRide['departure_station'] ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-xs-12">
                                                        <div class="ticket_ride_arrival ticket_ride_info">
                                                            <div class="ticket_ride_time flex_ac">
                                                                <img src="<?= asset('images/legacy/common/clock.svg'); ?>" alt="clock">
                                                                <span class="btn_txt"><?= date('H:i', strtotime($futureRide['arrival_time'])) ?></span>
                                                            </div>
                                                            <div class="ticket_ride_city btn_txt">
                                                                <?= $futureRide['arrival_city'] ?>
                                                            </div>
                                                            <div class="ticket_ride_checkpoint">
                                                                <?= $futureRide['arrival_station'] ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button class="ticket_details_btn shedule_link flex_ac hidden-md hidden-sm hidden-xs"
                                                        onclick="toggleRouteDetailsPrivate('<?= $futureRide['tour_id'] ?>','<?= $futureRide['from_stop'] ?>','<?= $futureRide['to_stop'] ?>')">
                                        ...
                                        <div class="col-lg-12 hidden-md hidden-sm hidden-xs">
                                            <div class="ticket_totals">
                                                <div class="ticket_price private_ticket_price"><?= $totalPrice?>
                                                    ₴
                                                </div>
                                                <button class="return_ticket_btn h5_title"
                                                        onclick="toggleReturnBlock('<?= $futureRide['id'] ?>')">
                                        ...
                                        <div class="hidden-xxl hidden-xl hidden-lg col-sm-12 hidden-xs">
                                            <div class="ride_total_time">
                                                <div class="ticket_logo_wrapper">
                                                    <img src="<?= asset('images/legacy/common/ticket_logo_2.svg'); ?>" alt="ticket logo"
                                                         class="fit_img">
                                                </div>
                                                <div class="mobile_ticket_ride_total_time_wrapper flex_ac">
                                                    <div class="ticket_ride_total_time_info flex_ac">
                                                        ...
                                                        <div class="ticket_ride_total_time par">
                                                            <?= $futureRide['hours'].' '.$GLOBALS['dictionary']['MSG_MSG_TICKETS_GOD'].' '.$futureRide['minutes'].' '.$GLOBALS['dictionary']['MSG_MSG_TICKETS_HV_V_DOROZI']?>
                                                        </div>
                                                    </div>
                                                    <? if ($international) { ?>
                                                        <div class="ticket_ride_status par">
                                        ...
                                        <div class="hidden-xxl hidden-xl hidden-lg col-xs-12">
                                            <div class="mobile_ticket_totals flex_ac">
                                                <div class="mobile_ticket_details flex_ac">
                                                    <div class="ticket_price"><?= $totalPrice?> ₴</div>
                                                </div>
                                                <button class="return_ticket_btn h5_title"
                                                        onclick="toggleReturnBlock('<?= $futureRide['id'] ?>')">
                                                    <?=$GLOBALS['dictionary']['MSG_MSG_FUTURE_POVERNUTI_KVITOK']?>
                    ...
                    <div class="container">
                        <div class="private_empty_block">
                            <div class="private_empry_block_title h2_title">
                                <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_U_VAS_POKI_NEMA_MAJBUTNIH_POZDOK'] ?>
                            </div>
                            <div class="private_empry_block_subtitle">
                                <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_SCHOB_ZNAJTI_KVITKI_NA_AVTOBUS'] ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="return_thx_content_wrapper">
        ...
        <div class="return_thx_content">
            <div class="return_thx_content_title h2_title">
                <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_DYAKUYU_ZA_VASHE_ZVERNENNYA'] ?>
            </div>
            <div class="return_thx_content_subtitle par">
                <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_MI_ROZGLYANEMO_VASHU_ZAYAVKU_TA_NASH_MENEDZHER_ZVYAZHETISYA_Z_VAMI_YAK_NAJSHVIDSHE'] ?>
            </div>
            <button class="go_private blue_btn h4_title" onclick="closeThxReturn()">
                <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_POVERNUTISYA_U_PERSONALINIJ_KABINET'] ?>
            </button>
        </div>
        <div class="return_thx_img">
            <img src="<?= asset('images/legacy/common/thx_return.png'); ?>" alt="thx" class="fit_img">
        </div>
    </div>
</div>
    ...
    function initializePopUpScripts() {
        ...
        function updateTotalPrice() {
            ...
            if (totalPriceElement) {
                totalPriceElement.textContent = totalPrice + ' <?= $GLOBALS['dictionary']['MSG_MSG_FUTURE_GRN'] ?>';
            }
        }
           ...
           type:'post',
            ...
            success:function(response) {
                ...
                if ($.trim(response) == 'ok') {
                    ...
                    out('<?=$GLOBALS['dictionary']['MSG_MSG_FUTURE_NE_UDALOSI_OFORMITI_VOZVRAT_POPROBUJTE_POZZHE']?>');
                }
            }
        })
