                    ...
                    <div class="flex-row gap-30 welcome_block_wrapper">
                        ...
                        <div class="col-lg-6">
                            <div class="welcome_img">
                                <img src="<?= asset('images/legacy/upload/wellcome/' . $wellcomeInfo['image']); ?>" alt="welcome" class="fit_img">
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="advantage_slide">
                                            <div class="advantage_slide_content">
                                                <div class="advantage_img">
                                                    <img src="<?= asset('images/legacy/upload/advantage/' . $advantage['image']); ?>" alt="advantage" class="fit_img">
                                                </div>
                    ...
                    <div class="flex-row gap-30">
                        ...
                        <div class="col-lg-6">
                            <div class="about_us_img">
                                <img src="<?= asset('images/legacy/upload/wellcome/' . $aboutUsTxt['image']); ?>" alt="about us" class="fit_img">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="company_docs_slider">
                        ...
                        foreach ($getCompanyDocs AS $k=>$companyDoc){?>
                            <div class="company_docs_slide">
                                <img src="<?= asset('images/legacy/upload/company_docs/' . $companyDoc['image']); ?>" alt="doc 1" class="fit_img">
                            </div>
                        <?}?>
                    </div>
