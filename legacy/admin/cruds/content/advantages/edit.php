        ...
        <? if (isset($_POST['ok']) && $Admin->CheckPermission($_params['access_edit'])) {
            ...
            if (isset($_FILES['image']['tmp_name']) && $_FILES['image']['tmp_name'] != '') {
               ...
               // $outputPath = str_replace('public', 'legacy', $_SERVER['DOCUMENT_ROOT']) . '/'.$_params['image'].$FileName;
                $outputPath = public_path('images/legacy/upload/advantage/' . $FileName);
                $imageProcessor = new ImageProcessor($inputFile, $outputPath, $_params['image_width'], $_params['image_height']);
                //$imageProcessor->processImage();
                $extension = $imageProcessor->cropImage($_params['image_width'], $_params['image_height']);
                $FileName = str_replace('.webp', $extension, $FileName);
                /*move_uploaded_file($FileName, public_path('images/legacy/upload/advantage/'));*/
            }else{
                    ...
                    <div class="tab-content card-body" id="custom-content-above-tabContent">
                        <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img style="max-width: 300px;" src="<?= asset('images/legacy/upload/advantage/' . $Elem['image']); ?>" />
