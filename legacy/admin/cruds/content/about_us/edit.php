                    ...
                    <div class="tab-content card-body" id="custom-content-above-tabContent">
                        <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <img style="max-width: 300px;" src="<?= asset('images/legacy/upload/wellcome/' . $Elem['image']); ?>" />
                            ...
                            <? foreach( $Admin->langs as $key => $lang_index ){?>
                                ...
                                <? editElem('text', 'Текст ('.$lang_index['code'].')', '4', $Elem,  $lang_index['code'], 'edit',1,7); ?>
                                <? editElem('title_2',  'Заголовок 2 ('.$lang_index['code'].')', '1', $Elem,  $lang_index['code'], 'edit', 1, 7 ); ?>
                                <? editElem('text_2', 'Текст 2 ('.$lang_index['code'].')', '4', $Elem,  $lang_index['code'], 'edit',1,7); ?>
                            <? } ?>
                        </div>
                    </div>
