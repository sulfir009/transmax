    ...
    <div class="content-wrapper">
        ...
        <? if (isset($_POST['ok']) && $Admin->CheckPermission($_params['access_edit'])) {
            ...
            if (isset($_FILES['image']['tmp_name']) && $_FILES['image']['tmp_name'] != '') {
                ...
                $outputPath = $_SERVER['DOCUMENT_ROOT'] . 'images/legacy/upload/reviews/'. $FileName;
                ...
                <form method="post" enctype="multipart/form-data" class="card">
                    ...
                    <div class="tab-content card-body" id="custom-content-above-tabContent">
                        <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
                            ...
                            <? editElem('name', 'Имя', '1', $Elem,  '', 'edit', 1); ?>
                            <? foreach( $Admin->langs as $key => $lang_index ){?>
                                <? editElem('review', 'Отзыв ('.$lang_index['code'].')', '8', $Elem,  $lang_index['code'], 'edit', 1); ?>
                            <? } ?>
