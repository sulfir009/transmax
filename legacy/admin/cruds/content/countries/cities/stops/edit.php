            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <a href="index.php?parent=<?=$parent?>&city=<?=(int)$_GET['city']?>" class="btn btn-info mt-2">Назад</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="tab-content card-body" id="custom-content-above-tabContent">
                        <div class="tab-pane fade show active" id="tab_1" role="tabpanel" aria-labelledby="tab_1">
                            ...
                            <? foreach( $Admin->langs as $key => $lang_index ){?>
                                <? editElem('title',  'Название ('.$lang_index['code'].')', '1', $Elem,  $lang_index['code'], 'edit', 1, 7 ); ?>
                            <? } ?>
                            <? editElem('google_maps_link',  'Ссылка на точку на карте', '1', $Elem,  '', 'edit', 1, 7 ); ?>
