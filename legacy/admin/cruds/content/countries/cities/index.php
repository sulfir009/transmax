            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <a class="btn btn-success float-right" role="button" href="<?= $_SERVER['REQUEST_URI'] . '/create.php' ?>?parent=<?=$parent?>">
                        ...
                        <table class="table m-0">
                            ...
                            while ($Elem = mysqli_fetch_assoc($getTableElems)) {
                                ...
                                <?} else { ?> class="fas fa-toggle-on" <?} ?>></i>
                                            ...
                                            <a href="<?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) . '/edit.php' ?>?id=<?= $Elem['id'] ?>&parent=<?=$parent?>" class="btn btn-default"
                                               title="Редактировать">
