                    ...
                    <div class="table-responsive table-striped table-valign-middle">
                        <table class="table m-0">
                            ...
                            <tr>
                                <th>ID</th>
                                <th>Название</th>
                                <th width="210" style="text-align:center;">Показывать в блоке на главной</th>
                                <th style="text-align:center;">Действия</th>
                            </tr>
                            </thead>
                            <tbody>
                            <? $getTableElems = mysqli_query($db, "SELECT * FROM `" . $_params['table'] . "` WHERE section_id = '0' ORDER BY id DESC ");
                                ...
                                <? } ?>>
                                    ...
                                    <td align="center" width="210">
                                        <div class="btn btn-default">
                                            <i class="<?if ($Elem['show_home'] == '1') {?> fas fa-check <?} else  {?> fas fa-times <?}?>" ></i>
                                        </div>
                                    </td>
                                    <td align="center" width="210">
                                        <div class="btn-group wgroup">
                                            <a href="countries/cities/index.php?parent=<?= $Elem['id'] ?>" class="btn btn-default"
                                               title="Города">
