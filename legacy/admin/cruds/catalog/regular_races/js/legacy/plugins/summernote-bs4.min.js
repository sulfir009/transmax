...
/*!**********************************************************************!*\
  !*** ./resources/js/legacy/plugins/summernote/summernote-bs4.min.js ***!
  \**********************************************************************/
  ...
  return function () {
    ...
    return function () {
      ...
      function vt(t, e) {
        ...
        for (n = 0; n < a.length; n++) if (!ht.isText(a[n])) {
        ...
        return n = t, o = [{
          ...
          value: function value() {
            var e = function e(t, _e) {
                if (!t) return t;
                if (ht.isVisiblePoint(t) && (!ht.isEdgePoint(t) || ht.isRightEdgePoint(t) && !_e || ht.isLeftEdgePoint(t) && _e || ht.isRightEdgePoint(t) && _e && ht.isVoid(t.node.nextSibling) || ht.isLeftEdgePoint(t) && !_e && ht.isVoid(t.node.previousSibling) || ht.isBlock(t.node) && ht.isEmpty(t.node))) return t;
                ...
                if (!o) {
                  ...
                  o = (ht.isLeftEdgePointOf(t, n) || ht.isVoid(i.node)) && !_e;
                }
                var r = !1;
                if (!r) {
                  ...
                  r = (ht.isRightEdgePointOf(t, n) || ht.isVoid(a.node)) && _e;
                }
                if (o || r) {
                  if (ht.isVisiblePoint(t)) return t;
                  _e = !_e;
                }
                return (_e ? ht.nextPointUntil(ht.nextPoint(t), ht.isVisiblePoint) : ht.prevPointUntil(ht.prevPoint(t), ht.isVisiblePoint)) || t;
              },
      ...
      var Lt = function () {
        ...
        return n = t, o = [{
          ...
          key: "deleteRow",
          value: function value(t) {
            for (var n = ht.ancestor(t.commonAncestor(), ht.isCell), o = e()(n).closest("tr"), i = o.children("td, th").index(e()(n)), r = o[0].rowIndex, a = new Rt(n, Rt.where.Row, Rt.requestAction.Delete, e()(o).closest("table")[0]).getActionList(), s = 0; s < a.length; s++) if (a[s]) {
              var l = a[s].baseCell,
                c = a[s].virtualTable,
          ...
          key: "deleteCol",
          value: function value(t) {
            for (var n = ht.ancestor(t.commonAncestor(), ht.isCell), o = e()(n).closest("tr"), i = o.children("td, th").index(e()(n)), r = new Rt(n, Rt.where.Column, Rt.requestAction.Delete, e()(o).closest("table")[0]).getActionList(), a = 0; a < r.length; a++) if (r[a]) switch (r[a].action) {
              case Rt.resultAction.Ignore:
                continue;
              case Rt.resultAction.SubtractSpanCount:
                var s = r[a].baseCell;
        ...
        return n = t, o = [{
          ...
          value: function value(t, n) {
            ...
            return (o = t, e().Deferred(function (t) {
              ...
              i.context.triggerEvent("images.upload.error", t);
            });
          }
        }, {
          ...
          value: function value(t) {
            ...
            e().each(t, function (t, o) {
              var i = o.name;
              n.options.maximumImageFileSize && n.options.maximumImageFileSize < o.size ? n.context.triggerEvent("images.upload.error", n.lang.image.maximumFileSizeError) : function (t) {
                ...
                n.context.triggerEvent("images.upload.error");
              });
            });
          }
        }, {
          ...
          value: function value(t) {
            this.options.callbacks.onImageUpload ? this.context.triggerEvent("images.upload", t) : this.insertImagesAsDataURL(t);
          }
        }, {
          key: "getSelectedText",
          value: function value() {
        ...
        return e = t, (n = [{
          ...
          value: function value(t) {
            ...
            if (n && n.items && n.items.length) {
              ...
              "file" === o.kind && -1 !== o.type.indexOf("images/") ? (this.context.invoke("editor.insertImagesOrCallback", [o.getAsFile()]), t.preventDefault()) : "string" === o.kind && this.context.invoke("editor.isLimited", n.getData("Text").length) && t.preventDefault();
      ...
      var ee = function () {
        ...
        return e = t, (n = [{
          ...
          key: "handleKeydown",
          value: function value(t) {
            if (this.previousKeydownCode && k.contains(this.keys, this.previousKeydownCode)) this.previousKeydownCode = t.keyCode;else {
      ...
      var de = function () {
        function t(n) {
          ...
          !function (t, e) {
            ...
            "summernote.blur": function summernoteBlur(t, e) {
        ...
        return n = t, (o = [{
          ...
          value: function value() {
            ...
            var o = this.options.dialogsInBody ? this.$body : this.options.container,
              ...
              r = '<input type="button" href="#" class="'.concat("btn btn-primary note-btn note-btn-primary note-images-btn", '" value="').concat(this.lang.image.insert, '" disabled>');
            this.$dialog = this.ui.dialog({
          ...
          value: function value() {
            ...
            this.context.invoke("editor.saveRange"), this.showImageDialog().then(function (e) {
              t.ui.hideDialog(t.$dialog), t.context.invoke("editor.restoreRange"), "string" == typeof e ? t.options.callbacks.onImageLinkInsert ? t.context.triggerEvent("images.link.insert", e) : t.context.invoke("editor.insertImage", e) : t.context.invoke("editor.insertImagesOrCallback", e);
            }).fail(function () {
              t.context.invoke("editor.restoreRange");
            });
          }
          ...
          value: function value() {
            var t = this;
            return e().Deferred(function (e) {
              var n = t.$dialog.find(".note-images-input"),
                o = t.$dialog.find(".note-images-url"),
                i = t.$dialog.find(".note-images-btn");
      ...
      var ye = function () {
        ...
        return n = t, (o = [{
          ...
          value: function value(t) {
            ...
            } else if (f || p || m) n = e()("<video controls>").attr("src", t).attr("width", "640").attr("height", "360");else {
      ...
      var xe = function () {
        ...
        return n = t, (o = [{
          ...
          value: function value(t) {
            ...
            if (!n.range || n.range.isCollapsed() && !t) this.hide();else {
              var o = {
                  left: this.pageX,
                  top: this.pageY
                },
      ...
      e().summernote = e().extend(e().summernote, {
        ui_template: function ui_template(t) {
          return {
            editor: Re,
            toolbar: Le,
            editingArea: Ae,
