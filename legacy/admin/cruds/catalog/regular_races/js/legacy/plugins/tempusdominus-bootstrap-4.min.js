...
/*!***************************************************************************************************!*\
  !*** ./resources/js/legacy/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js ***!
  \***************************************************************************************************/
...
!function () {
  ...
  var a,
    ...
    M = (a = jQuery, n = moment, l = {
      ...
      keyBinds: {
        ...
        "control space": function control_space() {
  ...
  E = jQuery, t = E.fn[M.NAME], p = ["top", "bottom", "auto"], C = ["left", "right", "auto"], T = ["default", "top", "bottom"], x = function (d) {
    ...
    return i._init = function () {
      ...
      if ("object" == _typeof(e) && E.extend({}, M.Default, e), s || (s = new n(E(t), e), E(t).data(M.DATA_KEY, s)), "string" == typeof e) {
