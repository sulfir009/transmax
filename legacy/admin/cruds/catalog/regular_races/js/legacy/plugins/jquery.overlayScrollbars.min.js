...
/*!******************************************************************************************!*\
  !*** ./resources/js/legacy/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js ***!
  \******************************************************************************************/
...
!function (t, r) {
...
}("undefined" != typeof window ? window : undefined, function (vi, di, hi, n) {
  "use strict";
  ...
  var i,
    ...
    w = (g = [], L = Si.type, y = {
      ...
      m: (m = function m(i) {
        var _o = function o(n) {
          var t, r, e;
          for (t in n) n[xi.hOP](t) && (r = n[t], (e = L(r)) == yi ? n[t] = r[i ? 1 : 0] : e == pi && (n[t] = _o(r)));
          return n;
        };
        return _o(Ci.extend(!0, {}, y));
      })(),
      g: m(!0),
      _: function _(n, t, C, r) {
          ...
          _R = function R(n, t, r, e, i, o) {
            for (var a in t) if (t[xi.hOP](a) && n[xi.hOP](a)) {
              var u,
                ...
                O = [],
                k = [];
              if (x = x === hi ? {} : x, g && S == pi) e[a] = {}, i[a] = {}, _R(_, y, x, e[a], i[a], z + a), Ci.each([n, e, i], function (n, t) {
                H(t[a]) && delete t[a];
              });else if (!g) {
        ...
        return _R(o, t, r || {}, e, i), !H(o) && C && console.warn("The following options are discarded due to invalidity:\r\n" + vi.JSON.stringify(o, null, 2)), {
          S: e,
          z: i
        };
      }
  ...
  function S(r) {
    ...
    this.add = function (n) {
      -1 === e(n, d) && (d.push(n), h.push(s()), 0 < d[v] && !p && (p = !0, r.autoUpdateLoop = p, _m()));
  ...
  function z(r, n, t, xt, _t) {
            ...
            _S = function S() {
              if (!Lt) {
                ...
                f = isFinite(f) ? f : 0, f = Vt && z && !Ot.i ? i - f : f, m ? (Zt[H](f), g ? (f = Zt[H](), Zt[H](o), f = c && Ot.i ? i - f : f, f = c && Ot.n ? -f : f, l[A] = f, St.scroll(l, fi(v, {
                  duration: 130,
                  complete: _
                }))) : _()) : (d = w ? s : d, (c ? d ? n <= t + e : t <= n : d ? t <= n : n <= t + e) ? (clearTimeout(T), St.scrollStop(), T = hi, x(!0)) : (T = setTimeout(_S, u), l[A] = (d ? "-=" : "+=") + h, St.scroll(l, fi(v, {
                  duration: a
                }))), w = !1);
              }
            };
          r && l(), k = vt()[A], O = Si.page(n)[A], V = !s(a), ci(P, En), ci(e.un, o), ci(e.an, o), Yn(F, [q, K, G, J], [D, L, N, tt]), _S(), Si.prvD(n), Si.stpP(n);
        }
      }, function b(n) {
        U = !0, (Kr || Gr) && Ge(!0);
      }, function y(n) {
    ...
    function lt(n, t) {
      var r,
        ...
        i,
        o = function o(n, t) {
          if (i = "", t && _typeof(n) == mi) for (e = n.split(xe), r = 0; r < e[xi.l]; r++) i += "|" + e[r] + "$";
          return i;
        };
