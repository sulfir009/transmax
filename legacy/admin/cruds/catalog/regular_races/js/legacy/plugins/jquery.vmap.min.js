...
/*!***************************************************************!*\
  !*** ./resources/js/legacy/plugins/jqvmap/jquery.vmap.min.js ***!
  \***************************************************************/
...
var _JQVMap = function JQVMap(a) {
  a = a || {};
  var b,
    c = this,
    d = _JQVMap.maps[a.map];
  ...
  }), this.canvas = new VectorCanvas(this.width, this.height, a), a.container.append(this.canvas.canvas), this.makeDraggable(), this.rootGroup = this.canvas.createGroup(!0), this.index = _JQVMap.mapIndex, this.label = jQuery("<div/>").addClass("jqvmap-label").appendTo(jQuery("body")).hide(), a.enableZoom && (jQuery("<div/>").addClass("jqvmap-zoomin").text("+").appendTo(a.container), jQuery("<div/>").addClass("jqvmap-zoomout").html("&#x2212;").appendTo(a.container)), c.countries = [];
...
_JQVMap.prototype = {
  ...
  zoomMaxStep: 4,
  zoomCurStep: 1
}, _JQVMap.xlink = "http://www.w3.org/1999/xlink", _JQVMap.mapIndex = 1, _JQVMap.maps = {}, function () {
  var a = {
      colors: 1,
      values: 1,
      backgroundColor: 1,
  ...
  jQuery.fn.vectorMap = function (c) {
    ...
    if ("addMap" === c) _JQVMap.maps[arguments[1]] = arguments[2];else {
      if ("set" !== c || !a[arguments[1]]) {
        ...
        jQuery.extend(d, c), d.container = this, this.css({
          position: "relative",
          overflow: "hidden"
        }), e = new _JQVMap(d), this.data("mapObject", e), this.unbind(".jqvmap");
  ...
  return b;
}, _JQVMap.prototype.applyTransform = function () {
  var a, b, c, d;
...
}, _JQVMap.prototype.bindZoomButtons = function () {
  var a = this;
...
}, _JQVMap.prototype.deselect = function (a, b) {
...
}, _JQVMap.prototype.getCountryId = function (a) {
  return "jqvmap" + this.index + "_" + a;
}, _JQVMap.prototype.getPin = function (a) {
  var b = jQuery("#" + this.getPinId(a));
  return b.html();
}, _JQVMap.prototype.getPinId = function (a) {
  return this.getCountryId(a) + "_pin";
}, _JQVMap.prototype.getPins = function () {
...
}, _JQVMap.prototype.highlight = function (a, b) {
...
}, _JQVMap.prototype.isSelected = function (a) {
  return this.selectIndex(a) >= 0;
}, _JQVMap.prototype.makeDraggable = function () {
  var a,
    b,
    c = !1,
    d = this;
...
}, _JQVMap.prototype.placePins = function (a, b) {
  var c = this;
...
}, _JQVMap.prototype.positionPins = function () {
  var a = this,
...
}, _JQVMap.prototype.selectIndex = function (a) {
  a = a.toLowerCase();
  for (var b = 0; b < this.selectedRegions.length; b++) if (a === this.selectedRegions[b]) return b;
  return -1;
}, _JQVMap.prototype.setBackgroundColor = function (a) {
  this.container.css("background-color", a);
}, _JQVMap.prototype.setColors = function (a, b) {
...
}, _JQVMap.prototype.zoomOut = function () {
  var a = this,
    b = (jQuery("#zoom").innerHeight() - 12 - 30 - 6 - 7 - 6) / (this.zoomMaxStep - this.zoomCurStep);
  if (a.zoomCurStep > 1) {
  ...
  if ("svg" === this.mode) b = this.createSvgNode("path"), b.setAttribute("d", a.path), null !== this.params.borderColor && b.setAttribute("stroke", this.params.borderColor), this.params.borderWidth > 0 && (b.setAttribute("stroke-width", this.params.borderWidth), b.setAttribute("stroke-linecap", "round"), b.setAttribute("stroke-linejoin", "round")), this.params.borderOpacity > 0 && b.setAttribute("stroke-opacity", this.params.borderOpacity), b.setFill = function (a) {
    ...
    b = this.createVmlNode("shape"), b.coordorigin = "0 0", b.coordsize = this.width + " " + this.height, b.style.width = this.width + "px", b.style.height = this.height + "px", b.fillcolor = _JQVMap.defaultFillColor, b.stroked = !1, b.path = VectorCanvas.pathSvgToVml(a.path);
