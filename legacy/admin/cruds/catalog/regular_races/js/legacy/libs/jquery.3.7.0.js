...
/*!*********************************************************!*\
  !*** ./resources/js/legacy/libs/jquery/jquery.3.7.0.js ***!
  \*********************************************************/
...
!function (e, t) {
  ...
  !function () {
      ...
      if (!r && (V(e), e = e || T, C)) {
        ...
        if (!(h[t + " "] || d && d.test(t))) {
          if (c = t, f = e, 1 === p && (x.test(t) || m.test(t))) {
            (f = H.test(t) && z(e.parentNode) || e) == e && le.scope || ((s = e.getAttribute("id")) ? s = _ce.escapeSelector(s) : e.setAttribute("id", s = S)), o = (l = Y(t)).length;
    ...
    function V(e) {
      ...
      return n != T && 9 === n.nodeType && n.documentElement && (r = (T = n).documentElement, C = !_ce.isXMLDoc(T), i = r.matches || r.webkitMatchesSelector || r.msMatchesSelector, ye != T && (t = T.defaultView) && t.top !== t && t.addEventListener("unload", R), le.getById = $(function (e) {
    ...
    }), _ce.find = I, _ce.expr[":"] = _ce.expr.pseudos, _ce.unique = _ce.uniqueSort, I.compile = ne, I.select = re, I.setDocument = V, I.escape = _ce.escapeSelector, I.getText = _ce.text, I.isXML = _ce.isXMLDoc, I.selectors = _ce.expr, I.support = _ce.support, I.uniqueSort = _ce.uniqueSort;
  }();
  ...
  var _R = function R(e, t, n, r, i, o, a) {
      var s = 0,
        u = e.length,
        l = null == n;
      if ("object" === x(n)) for (s in i = !0, n) _R(e, t, s, n[s], !0, o, a);else if (void 0 !== r && (i = !0, v(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function t(e, _t2, n) {
  ...
  function Fe(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      X.hasData(e) && (o = X.access(e), a = _ce.extend({}, o), X.set(t, a));
    }
  }
  function $e(n, r, i, o) {
    r = g(r);
  ...
  function Ge(e, t, n) {
    var r,
      ...
      s = Xe.test(t),
      u = e.style;
    return (n = n || Ue(e)) && (a = n.getPropertyValue(t) || n[t], s && a && (a = a.replace(ve, "$1") || void 0), "" !== a || K(e) || (a = _ce.style(e, t)), !le.pixelBoxStyles() && _e.test(a) && Ve.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = a, a = n.width, u.width = r, u.minWidth = i, u.maxWidth = o)), void 0 !== a ? a + "" : a;
  }
  function Ye(e, t) {
    return {
      get: function get() {
  ...
  _ce.extend({
    ...
    css: function css(e, t, n, r) {
      var i,
        ...
        a,
        s = F(t);
      return Xe.test(t) || (t = Ze(s)), (a = _ce.cssHooks[t] || _ce.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ge(e, t, r)), "normal" === i && t in nt && (i = nt[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    }
  }), _ce.each(["height", "width"], function (e, u) {
    _ce.cssHooks[u] = {
      get: function get(e, t, n) {
        if (t) return !et.test(_ce.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ot(e, u, n) : ze(e, tt, function () {
          return ot(e, u, n);
        });
      },
      set: function set(e, t, n) {
    ...
    css: function css(e, t) {
      return _R(this, function (e, t, n) {
        var r,
          ...
          a = 0;
        if (Array.isArray(t)) {
          for (r = Ue(e), i = t.length; a < i; a++) o[t[a]] = _ce.css(e, t[a], !1, r);
          return o;
        }
