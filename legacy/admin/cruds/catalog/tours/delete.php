...
if( $Admin->CheckPermission($_params['access_delete']) )
{
    ...
    if ( !isset($id) ):
        ...
        $deleteStops = mysqli_query($db, "DELETE FROM `".DB_PREFIX."_tours_stops` WHERE tour_id = '".$id."'");
        $deleteStopsPrices = mysqli_query($db, "DELETE FROM `".DB_PREFIX."_tours_stops_prices` WHERE tour_id = '".$id."'");
