                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-8"><?=$order['second_name'] . ' ' . $order['name'] . ' ' . $order['patronymic']?></dd>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-8"><?=$order['uniqid']?></dd>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-10">
                                            <?php 
                                            if ($order['return_payment_type'] == 1) {
                                                echo 'На карту';
                                            } elseif ($order['return_payment_type'] == 2) {
                                                echo 'Наличными';
                                            } else {
                                                echo 'Не указан';
                                            }
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($passenger->ticket_return == 1) { ?>
