<?php require_once str_replace('public', 'legacy', $_SERVER['DOCUMENT_ROOT']) . '/global_settings.php' ?>
<?php require_once str_replace('public', 'legacy', $_SERVER['DOCUMENT_ROOT']).'/'.ADMIN_PANEL.'/guard.php';?>
<!DOCTYPE html>
<html lang="en">
<head>
    <link rel="stylesheet" href="/<?php echo ADMIN_PANEL?>/template/plugins/fullcalendar/main.css">
...
<script src="/<?php echo ADMIN_PANEL?>/template/plugins/fullcalendar/main.js"></script>
