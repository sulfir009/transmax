...
dd(str_replace('public', 'legacy', $_SERVER['DOCUMENT_ROOT']) . "/pages/private/LiqPay.php");
require_once(str_replace('public', 'legacy', $_SERVER['DOCUMENT_ROOT']) . "/pages/private/LiqPay.php");
require_once(str_replace('public', 'legacy', $_SERVER['DOCUMENT_ROOT']) . "/private/payment_keys.php");
...
function generateAndSendPdf($paymentData, $orderInfo, $ticketInfo, $tourInfo, $from_city, $to_city, $from_stop, $to_stop) {
    ...
    $getPassangers = $Db->getAll("SELECT name, second_name, patronymic FROM `" .  DB_PREFIX . "_orders_passangers`WHERE order_id = '".$order_id."'");
...
function sendEmailWithAttachment($pdfFilePath, $orderInfo, $ticketInfoб , $passangers = []) {
