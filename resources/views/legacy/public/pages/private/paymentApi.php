...
require_once(str_replace('public', 'legacy', $_SERVER['DOCUMENT_ROOT']) . '/app/services/Site.php');
...
function createPayment($orderId, $total_sum, $description, $public_key, $private_key) {
    ...
    $data = array(
        ...
        'order_id' => $orderId,
        'version' => '3',
        'server_url' => $Site->buildLink('/public/pages/liqPaycallback.php'),
        'result_url' => $Site->buildLink('/dyakuyu-za-bronyuvannya-biletu/'),
    );
