...
<div class="wrapper">
    ...
    <div class="content">
        <div class="private_links_wrapper">
            <div class="tabs_links_container hidden-xs">
                <div class="private_links">
                    ...
                    <div class="private_link_wrapper">
                        <a href="<?php echo $Router->writelink(79)?>" class="private_tab h4_title active">
        ...
        <div class="page_content_wrapper">
            <div class="container">
                <?php $clientInfo = $Db->getOne("SELECT name,second_name,patronymic,birth_date,email,phone,phone_code FROM `".DB_PREFIX."_clients` WHERE id = '".$User->id."' ")?>
                <div class="flex-row gap-x-32 gap-y-60">
                    <div class="col-xxl-6">
                        <div class="shadow_block private_contacts_block">
                            <div class="private_contacts_header">
                                <?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_NA_ELEKTRONNU_POSHTU_NADSILAMO_MARSHRUTNI_KVITANCI']?>
                            </div>
                            <div class="flex-row gap-26">
                                <div class="col-sm-12">
                                    <div class="row">
                                        <input type="text" class="c_input" placeholder="<?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_YOREMAILGMAILCOM']?>" value="<?php echo $User->email?>" readonly>
                                    </div>
                                </div>
                                <?/*
                                <div class="col-sm-5">
                                    <button class="contact_act_btn blue_btn h4_title">
                                        <?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_ZMINITI_EMAIL']?>
                                    </button>
                                </div>*/?>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-6">
                        <div class="shadow_block private_contacts_block">
                            <div class="private_contacts_header">
                                <?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_TELEFONOM_MI_ZMOZHEMO_']?>
                            </div>
                            <div class="flex-row gap-26">
                                <div class="col-sm-7">
                                    <div class="row">
                                        <div class="phone_input_wrapper flex_ac">
                                            <select class="phone_country_code flex_ac" onchange="changeInputMask(this)" id="phone_code">
                                                ...
                                                foreach ($getPhoneCodes AS $k=>$phoneCode){
                                                    if ($k == 0 || $clientInfo['phone_code'] == $phoneCode['id']){
                                                        $firstPhoneExample = $phoneCode['phone_example'];
                                                        $firstPhoneMask = $phoneCode['phone_mask'];
                                                    }?>
                                                    <option value="<?php echo $phoneCode['id']?>" data-mask="<?php echo $phoneCode['phone_mask']?>" data-placeholder="<?php echo $phoneCode['phone_example']?>" <?php if ($k == 0 || $clientInfo['phone_code'] == $phoneCode['id']){echo 'selected';}?>><?php echo $phoneCode['phone_country']?></option>
                                                <?php }?>
                                            </select>
                    ...
                    <div class="col-xxl-12">
                        <div class="shadow_block private_data_block">
                            <div class="private_data_block_header h3_title">
                                <?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_OSOBISTI_DANI']?>
                            </div>
                            <div class="private_data_inputs">
                                <div class="flex-row gap-x-50 gap-y-30">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <input type="text" class="c_input" placeholder="<?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_IMYA']?>"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <input type="text" class="c_input" placeholder="<?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_FAMILIYA']?>"
                            ...
                            <button class="save_changes_btn h4_title blue_btn" onclick="updateClientInfo()">
                                <?php echo $GLOBALS['dictionary']['MSG_MSG_PRIVATE_CONTACTS_ZBEREGTI_ZMINI']?>
                            </button>
                        </div>
                    </div>
                </div>
                <button class="blue_btn h4_title exit_btn" onclick="exitAccount()">
                    Выход
                </button>
            </div>
        </div>
