        ...
        <div class="page_content_wrapper">
            <div class="container">
                <div class="our_buses_title h2_title">
                    <?php $busesTitle = $Db->getOne("SELECT title_".$Router->lang." AS title FROM `" .  DB_PREFIX . "_txt_blocks`WHERE id = 10 ")?>
                    <?php echo $busesTitle['title']?>
                </div>
                <div class="our_buses_subtitle par">
                    <?php $busesTxt = $Db->getOne("SELECT text_".$Router->lang." AS text FROM `" .  DB_PREFIX . "_txt_blocks`WHERE id = 10 ")?>
                    <?php echo $busesTxt['text']?>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="bus_img">
                                    <? foreach ($busImages as $busimg){ ?>
                                        <img src="<?php echo  asset('images/legacy/upload/buses/' . $busimg['bus_img']); ?>" alt="bus" class="fit_img">
                                    <? }?>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="bus_info">
                                    ...
                                    <div class="bus_seats flex_ac h4_title">
                                        <?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_KILIKISTI_MISCI']?>
                                    ...
                                    <button class="order_bus_link h4_title flex_ac blue_btn" onclick="toggleOrderBus('<?php echo $bus['id']?>', <?php echo  $bus['seats_qty'] ?>)">
                                        <?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_ZAMOVITI_AVTOBUS']?>
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <?php if ($busesCount['COUNT(id)'] > 6){?>
                    <button class="more_buses_btn h4_title" onclick="moreBuses()">
                        <?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_ZAVANTAZHITI_SCHE']?>
                    </button>
                <?php }?>
            </div>
        </div>
    ...
    <div class="order_bus_popup_content_wrapper">
        ...
        <div class="order_bus_popup_content">
            <div class="order_bus_row">
                <div class="order_bus_row_title" ><?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_ZVIDKI']?></div>
                <input type="text" class="c_input order_bus_input par req_input" placeholder="<?php echo $GLOBALS['dictionary']['MSG_MSG_BOOKING_IMYA_']?>" id="name"
                >
            </div>
            <div class="order_bus_row">
                <div class="order_bus_row_title" ><?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_KUDI']?></div>
                <div class="flex_ac">
                    ...
                    <input type="text" class="c_input order_bus_phone order_bus_input inter req_input" placeholder="<?php echo $firstPhoneExample?>" id="phone"
            ...
            <div class="order_bus_row order_bus_date">
                <div class="order_bus_row_title"><?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_KOLI']?></div>
            ...
            <div class="order_bus_row">
                <div class="order_bus_passengers_wrapper">
                    <div class="order_bus_row_title" ><?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_PASAZHIRI']?></div>
                    <? $adults = 1;
                    $kids = 0;
                    ...
                    <div class="order_bus_row_value flex_ac" onclick="toggleOrderBusSubmenu(this)">
                        ...
                        <div>
                            <span class="kids_total"><?php echo  $kids ?></span> <?php echo  $GLOBALS['dictionary']['MSG_MSG_BUSES_DITEJ'] ?>
                        </div>
                    </div>

                    <div class="order_bus_row_submenu">
                        <div class="passengers_counter_block flex_ac adult_passagers">
                            <div class="passengers_counter_title h5_title"><?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_DOROSLIH']?></div>
                            <div class="passengers_counter flex_ac">
                                ...
                                <div class="p_counter_value par"><?php echo $adults?></div>
                        ...
                        <div class="passengers_counter_block flex_ac">
                            <div class="passengers_counter_title h5_title">
                                <?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_DITEJ']?>
                                <span><?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_DO_3_ROKIV_-_BEZKOSHTOVNO']?></span>
                            </div>
                            <div class="passengers_counter flex_ac">
                                <button class="counter_btn minus" onclick="countPassagers(this,'minus','kids')">
                                    <img src="<?php echo  asset('images/legacy/common/minus.svg'); ?>" alt="minus">
                                </button>
                                <div class="p_counter_value par"><?php echo $kids?></div>
            ...
            <button class="blue_btn flex_ac h4_title order_bus_btn" onclick="orderBus()">
                <?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_ZABRONYUVATI_AVTOBUS']?>
            </button>
        </div>
        <div class="order_bus_rules">
            <div class="order_bus_rules_title h3_title flex_ac"
                ...
                <?php echo $GLOBALS['dictionary']['MSG_MSG_BUSES_PRAVILA_BRONYUVANNYA_AVTOBUSA']?>
                <img src="<?php echo  asset('images/legacy/common/arrow_down.svg'); ?>" alt="arrow">
            </div>
            <div class="order_bus_rules_txt par">
                <?php $bookingTxt = $Db->getOne("SELECT text_".$Router->lang." AS text FROM `".DB_PREFIX."_txt_blocks` WHERE id = '8' ")?>
                <?php echo $bookingTxt['text']?>
                <div class="order_bus_rules_txt_warning">
                    <div class="warning_img">
                        <img src="<?php echo  asset('images/legacy/common/warning.svg'); ?>" alt="warning">
                    </div>
                    <div class="warning_txt par">
                        <?php $bookingWarning = $Db->getOne("SELECT text_".$Router->lang." AS text FROM `".DB_PREFIX."_txt_blocks` WHERE id = '9' ")?>
                        <?php echo $bookingWarning['text']?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('.order_bus_phone').mask("<?php echo $firstPhoneMask?>");
    ...
    function searchTicketsByBus(){
        ...
        let url = '<?php echo $Router->writelink(76)?>';
